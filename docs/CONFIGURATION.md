...
| 变量 | 默认值 | 说明 |
|---|---|---|
| `SLIME_APP_IMAGE` | `ghcr.io/moumouhao12138-sketch/slime:0.0.42` | API/Dispatcher 共用镜像 |
| `SLIME_WORKER_IMAGE` | `ghcr.io/moumouhao12138-sketch/slime-worker:0.0.42` | 项目 Worker 镜像 |
...
| `SLIME_KALI_APT_MIRROR` | `http://kali.download/kali` |
