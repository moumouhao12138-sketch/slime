...
def build_service() -> tuple[Blackboard, DispatcherService]:
    ...
    try:
        ...
        factory = DockerCairnRuntimeFactory(
            ...
            lab_network=os.environ.get("SLIME_LAB_NETWORK", "slime-lab"),
            workspace_volume=os.environ.get("SLIME_WORKSPACES_VOLUME", ""),
