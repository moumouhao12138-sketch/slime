# Task
This is the conclude phase for a Bootstrap task. The earlier execute pass ended without a usable structured result.
...
- Return one already-confirmed Fact and do not output `complete`.
