...
from .models import FactCandidate, HypothesisCandidate, IntentProposal
from .nutrients import NutrientEngine
from .seeding import seed_project_context_facts
from .validation import FactEvidenceGate, HypothesisGate, IntentGate
...
def main() -> None:
    ...
    uvicorn.run("slime_cairn.api:app", host="127.0.0.1", port=8000, reload=False)
