...
默认应用镜像为 `ghcr.io/moumouhao12138-sketch/slime:0.0.41`，默认 Worker 镜像为 `ghcr.io/moumouhao12138-sketch/slime-worker:0.0.41`。
...
Agent Match 测试平台创建的项目固定使用 `hybrid`：Bootstrap 只负责建立初始事实，随后由 Reason 创建 Explore 分支；平台题目的历史项目保留创建时记录的启动模式。
